...
if os.path.isfile(nombre+".user"):
    #Esto lo hacemos si ya habí­a un usuario con ese nombre
    ...
    #En caso que el usuario no exista, consultamos por sus datos tal como lo hací­amos antes
    print()
...
#con un nombre de usuario que ya habí­as usado antes.
...
#¿Qué ocurre si en una ocasion ingreso mi nombre con mayúsculas, y en otra ocasión lo hago con minúsculas?
#
...
#   y retornen el conjunto de datos leí­dos, de manera de encapsular el proceso de lectura y escritura,
