...
#A continuaciónn preguntaremos algunos datos al usuario para poder construir su perfil,
...
genero = input("Por otro lado, para crear sugerencias de contenidos te invitamos a responder lo siguiente \n ¿Cuál es tu genero? ")
telefono = input("¡Genial!\n¿Cuál es tu número telefónico? ")
ciudad = input("¡Muy bien!\n¿En qué ciudad vives? ")
pais = input ("¡Es grandioso!\n¿En que país naciste? ")
direccion = input("¡Qué bonito lugar!\nPor último, ¿En dónde vives? ")

print("Nos da gusto que te unas a nuestar comunidad\n En seguida confirmaremos tus datos")
print("Bienvenido ", nombre, "del sexo ", genero)
print("Con número telefónico ", telefono, "de la ciudad de", ciudad)
print("Originario de", pais, " con domicilio en", direccion)
